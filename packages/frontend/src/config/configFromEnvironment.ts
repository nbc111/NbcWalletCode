...
export default {
    ...
    FT_MINIMUM_STORAGE_BALANCE:
        process.env.FT_MINIMUM_STORAGE_BALANCE || '1250000000000000000000',
    FT_MINIMUM_STORAGE_BALANCE_LARGE:
        process.env.FT_MINIMUM_STORAGE_BALANCE_LARGE || '12500000000000000000000',
    FT_REGISTRATION_DEPOSIT:
        process.env.FT_REGISTRATION_DEPOSIT || '365000000000000000000',
    FT_REGISTRATION_DEPOSIT_GAS:
        process.env.FT_REGISTRATION_DEPOSIT_GAS || '10000000000000',
    ...
    SENTRY_RELEASE: process.env.SENTRY_RELEASE
        ? parseBooleanFromShell(process.env.RENDER)
            ...
            : undefined
        : undefined,
    SHOW_PRERELEASE_WARNING: parseBooleanFromShell(process.env.SHOW_PRERELEASE_WARNING),
    SMS_BLACKLIST: envValIsSet(process.env.SMS_BLACKLIST)
        ? parseCommaSeperatedStringAsArrayFromShell(
    ...
    NEAR_ID: process.env.NEAR_ID || 'NBC',
    NEAR_DECIMALS: 24,
